...
const { FIELD_TYPE, REQUEST, PU, CT, VS, KEY } = require("./constants");
...
const CONTROLS = {
  ...
  [KEY.auto_exposure_priority]: {
    ...
    type: "PU",
    wLength: 1,
    requests: [REQUEST.SET_CUR, REQUEST.GET_CUR, REQUEST.GET_INFO],
    fields: [
      {
        name: "bAutoExposurePriority",
        description:
          "The setting for the attribute of the addressed AutoExposure Priority control.",
        type: FIELD_TYPE.NUMBER,
        offset: 0,
        size: 1
      }
    ...
    fields: [
      {
        ...
        description:
          "The setting for the attribute of the addressed Exposure Time (Absolute) Control. 0: Reserved, 1: 0.0001 sec, 100000: 10 sec",
        type: FIELD_TYPE.NUMBER,
        offset: 0,
        size: 4
      }
  ...
  [KEY.absolute_focus]: {
    description:
      "The Focus (Absolute) Control is used to specify the distance to the optimally focused target. This value is expressed in millimeters. The default value is implementation-specific. This control must accept the GET_DEF request and return its default value.",
    ...
    fields: [
      {
        name: "wFocusAbsolute",
        description:
          "The setting for the attribute of the addressed Focus (Absolute) Control.",
        type: FIELD_TYPE.NUMBER,
        offset: 0,
        size: 2
      }
  ...
  [KEY.absolute_zoom]: {
    ...
    optional_requests: [REQUEST.SET_CUR],
    fields: [
      {
    ...
    fields: [
      {
        name: "dwPanAbsolute",
        description:
          "The setting for the attribute of the addressed Pan (Absolute) Control.",
      ...
      },
      {
        name: "dwTiltAbsolute",
        description:
          "The setting for the attribute of the addressed Tilt (Absolute) Control.",
        type: FIELD_TYPE.NUMBER, // Signed Number
        offset: 4,
        size: 4
      }
    ...
    fields: [
      {
        name: "bFocusAuto",
        description:
          "The setting for the attribute of the addressed Focus Auto control.",
    ...
    fields: [
      {
        name: "bScanningMode",
        description:
          "The setting for the attribute of the addressed Scanning Mode Control",
        type: FIELD_TYPE.BOOLEAN,
        offset: 0,
        size: 1,
        options: {
    ...
    fields: [
      {
        ...
        description:
          "The setting for the attribute of the addressed Exposure Time (Relative) Control",
        type: FIELD_TYPE.NUMBER, // Signed Number
        offset: 0,
        size: 1,
        options: {
    ...
    fields: [
      {
        name: "bFocusRelative",
        description:
          "The setting for the attribute of the addressed Focus (Relative) Control",
        type: FIELD_TYPE.NUMBER, // Signed Number
        offset: 0,
        size: 1,
        options: {
    ...
    fields: [
      {
        name: "wIrisAbsolute",
        description:
          "The setting for the attribute of the addressed Iris (Absolute) Control.",
        offset: 0,
        size: 2,
        type: FIELD_TYPE.NUMBER
      }
    ...
    fields: [
      {
        name: "bIrisRelative",
        description:
          "The setting for the attribute of the addressed Iris (Relative) Control",
        type: FIELD_TYPE.NUMBER,
        offset: 0,
        size: 1,
        options: {
    ...
    fields: [
      {
        name: "bZoom",
        description:
          "The setting for the attribute of the addressed Zoom Control",
        type: FIELD_TYPE.NUMBER, // Signed number
        offset: 0,
        size: 1,
        options: {
    ...
    fields: [
      {
        name: "bPanRelative",
        description:
          "The setting for the attribute of the addressed Pan(Relative) Control",
        type: FIELD_TYPE.NUMBER, // Signed Number
        offset: 0,
        size: 1,
        options: {
      ...
      },
      {
        name: "bTiltRelative",
        description:
          "The setting for the attribute of the addressed Tilt(Relative) Control",
        offset: 2,
        size: 1,
        type: FIELD_TYPE.NUMBER, // Signed Number
        options: {
    ...
    fields: [
      {
        name: "wRollAbsolute",
        description:
          "The setting for the attribute of the addressed Roll (Absolute) Control.",
        type: FIELD_TYPE.NUMBER, // Signed Number
        offset: 0,
        size: 2
      }
    ...
    fields: [
      {
        name: "bRollRelative",
        description:
          "The setting for the attribute of the addressed Roll (Relative) Control",
        type: FIELD_TYPE.NUMBER, // Signed Number
        offset: 0,
        size: 1,
        options: {
  ...
  [KEY.power_line_frequency]: {
    description:
      "This control allows the host software to specify the local power line frequency, in order for the device to properly implement anti-flicker processing, if supported. The default is implementation-specific. This control must accept the GET_DEF request and return its default value.",
    ...
    fields: [
      {
        ...
        description:
          "The setting for the attribute of the addressed Power Line Frequency control.",
        type: FIELD_TYPE.NUMBER,
        offset: 0,
        size: 1,
        options: {
  ...
  [KEY.hue]: {
    description:
      "This is used to specify the hue setting. The value of the hue setting is expressed in degrees multiplied by 100. The required range must be a subset of -18000 to 18000 (-180 to +180 degrees). The default value must be zero. This control must accept the GET_DEF request and return its default value.",
    ...
    fields: [
      {
        name: "wHue",
        description:
          "The setting for the attribute of the addressed Hue control.",
        type: FIELD_TYPE.NUMBER, // Signed Number
        offset: 0,
        size: 2
      }
    ...
    fields: [
      {
        ...
        description:
          "The setting for the blue component of the addressed White Balance Component control.",
        type: FIELD_TYPE.NUMBER,
        offset: 0,
        size: 2
      },
      {
        ...
        description:
          "The setting for the red component of the addressed White Balance Component control.",
        type: FIELD_TYPE.NUMBER,
        offset: 1,
        size: 2
      }
  ...
  [KEY.auto_white_balance_component]: {
    description:
      "The White Balance Component Auto Control setting determines whether the device will provide automatic adjustment of the related control. A value of 1 indicates that automatic adjustment is enabled. Attempts to programmatically set the related control are then ignored. This control must accept the GET_DEF request and return its default value.",
    ...
    fields: [
      {
        ...
        description:
          "The setting for the attribute of the addressed White Balance Component, Auto control.",
        type: FIELD_TYPE.NUMBER,
        offset: 0,
        size: 1
      }
    ...
    fields: [
      {
        ...
        description:
          'A value specifying the upper bound for Z′cur (see section 2.4.2.5.2 "Digital Zoom".)',
        type: FIELD_TYPE.NUMBER,
        offset: 0,
        size: 2
      }
  ...
  [KEY.auto_hue]: {
    description:
      "The Hue Auto Control setting determines whether the device will provide automatic adjustment of the related control. A value of 1 indicates that automatic adjustment is enabled. Attempts to programmatically set the related control are then ignored. This control must accept the GET_DEF request and return its default value.",
    ...
    fields: [
      {
        name: "bHueAuto",
        description:
          "The setting for the attribute of the addressed Hue, Auto control.",
        type: FIELD_TYPE.NUMBER,
        offset: 0,
        size: 1
      }
  ...
  [KEY.analog_video_standard]: {
    description:
      "This is used to report the current Video Standard of the stream captured by the Processing Unit. ",
  ...
  [KEY.analog_lock_status]: {
    description:
      "This is used to report whether the video decoder has achieved horizontal lock of the analog input signal. If the decoder is locked, it is assumed that a valid video stream is being generated. This control is to be supported only for analog video decoder functionality.",
    ...
    fields: [
      {
        name: "wBrightness",
        description:
          "The setting for the attribute of the addressed Brightness control.",
        type: FIELD_TYPE.NUMBER, // Signed Number
        offset: 0,
        size: 2
      }
    ...
    fields: [
      {
        name: "wContrast",
        description:
          "The setting for the attribute of the addressed Contrast control.",
        type: FIELD_TYPE.NUMBER,
        offset: 0,
        size: 2
      }
    ...
    fields: [
      {
        name: "wGain",
        description:
          "The setting for the attribute of the addressed Gain control.",
        type: FIELD_TYPE.NUMBER,
        offset: 0,
        size: 2
      }
    ...
    fields: [
      {
        name: "wSaturation",
        description:
          "The setting for the attribute of the addressed Saturation control.",
        type: FIELD_TYPE.NUMBER,
        offset: 0,
        size: 2
      }
    ...
    fields: [
      {
        name: "wSharpness",
        description:
          "The setting for the attribute of the addressed Sharpness control.",
        type: FIELD_TYPE.NUMBER,
        offset: 0,
        size: 2
      }
    ...
    fields: [
      {
        ...
        description:
          "The setting for the attribute of the addressed White Balance Temperature control.",
        type: FIELD_TYPE.NUMBER,
        offset: 0,
        size: 2
      }
    ...
    fields: [
      {
        ...
        description:
          "The setting for the attribute of the addressed Backlight Compensation control.",
        type: FIELD_TYPE.NUMBER,
        offset: 0,
        size: 2
      }
  ...
  [KEY.auto_white_balance_temperature]: {
    description:
      "The White Balance Temperature Auto Control setting determines whether the device will provide automatic adjustment of the related control. A value of 1 indicates that automatic adjustment is enabled. Attempts to programmatically set the related control are then ignored. This control must accept the GET_DEF request and return its default value.",
    ...
    fields: [
      {
        ...
        description:
          "The setting for the attribute of the addressed White Balance Temperature, Auto control.",
        type: FIELD_TYPE.BOOLEAN,
        offset: 0,
        size: 1
      }
  ...
  [KEY.gamma]: {
    description:
      "This is used to specify the gamma setting. The value of the gamma setting is expressed in gamma multiplied by 100. The required range must be a subset of 1 to 500, and the default values are typically 100 (gamma = 1) or 220 (gamma = 2.2). This control must accept the GET_DEF request and return its default value",
    ...
    fields: [
      {
        name: "wGamma",
        description:
          "The setting for the attribute of the addressed Gamma control.",
        type: FIELD_TYPE.NUMBER,
        offset: 0,
        size: 2
      }
